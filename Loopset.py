...
#        unique,uniqueEdges,uniqCons,uniqueConsEdges,notOff = LoopKO.switchChoose(sils,indicesEdges,uniqueLoops,indicesConsEdges,uniqueConsLoops, graph)
#
#        for elem in indicesEdges: print elem
##        for elem in uniqueLoops: print elem
##        for elem in extraLoops: print elem
#        for elem in indicesConsEdges: print elem
...
#        for name in uniqueEdges: print name
